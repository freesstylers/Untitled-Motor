...
/*     SCANCODE_LOCKINGSCROLLLOCK = 132, */
    ...
    SCANCODE_MODE = 257,    /**< I'm not sure if this is really not covered
                                 ...
                                 *   special PACOMOD_MODE for it I'm adding it here
                                 */
...
{
    PACOMOD_NONE = 0x0000,
    PACOMOD_LSHIFT = 0x0001,
    PACOMOD_RSHIFT = 0x0002,
    PACOMOD_LCTRL = 0x0040,
    PACOMOD_RCTRL = 0x0080,
    PACOMOD_LALT = 0x0100,
    PACOMOD_RALT = 0x0200,
    PACOMOD_LGUI = 0x0400,
    PACOMOD_RGUI = 0x0800,
